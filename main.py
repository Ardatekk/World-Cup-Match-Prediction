...
def main() -> None:
    ...
    run_stage(
        "[1/12] Cleaning historical results...",
    ...
    run_stage(
        "[3/12] Standardizing team and fixture references...",
    ...
    run_stage(
        "[4/12] Enriching World Cup 2026 fixtures...",
    ...
    run_stage(
        "[5/12] Building base model dataset...",
    ...
    run_stage("[6/12] Fetching and transforming live World Cup matches...", run_live_data_pipeline)
    run_stage("[7/12] Resolving knockout fixtures...", build_knockout_matches)
    run_stage("[8/12] Fetching and transforming player data...", run_player_data_pipeline)
    run_stage("[9/12] Building ML features...", build_features)
    run_stage("[10/12] Training XGBoost...", train_xgb)
    run_stage("[11/12] Training Poisson model...", train_poisson)
    run_stage("[12/12] Generating World Cup predictions...", batch_predict)
